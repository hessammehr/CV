...
\name{\normalfont \huge \mb \fontspec{Lato} S. Hessam Moosavi Mehr}

\begin{resume}
\reversemarginpar
\begin{ncolumn}{2}
  Department of Electrical Engineering       & Phone: {\addfontfeatures{Numbers=Lining}(+1 778) 322 5954} \\
  Sharif University of Technology     & \href{mailto:hessammehr@gmail.com}{hessammehr@gmail.com} \\
  P.O. Box {\addfontfeatures{Numbers=Lining}11555-4363}, Tehran & \href{http://ee.sharif.edu/~hessammehr}{http://ece.ubc.ca/\textasciitilde hessamm} \\
 {\addfontfeatures{Numbers=Lining}1458889694} Iran               & \\
            & \\
\end{ncolumn}
%---------------------------------------------------------------------------
...
\section{education}
\begin{description}
\item [MASc] Electrical Engineering, \emph{University of British Columbia}, Vancouver, Canada \hspace{\fill} 2010–
...
\item[Databases]SQLite3, SQL Server, NoSQL
...
\item[Head] Resana Science\footnote{Resana Science is the name collectively given to independent and collaborative research by the student community in the Department of Electrical Engineering, Sharif University of Technology.}, 2008--2009
