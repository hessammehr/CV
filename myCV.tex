...
\setmainfont[Numbers=OldStyle,BoldFont=Chaparral Pro Semibold]{Chaparral Pro Regular}
\newfontfamily\titlesfont[Scale=0.95]{Lato}

\def\sectionfont{\scshape\large\mb\titlesfont\MakeUppercase}
\renewcommand\footnotelayout{\fontspec[Numbers=OldStyle]{Chaparral Pro Caption}}
...
\item[Scientific computation] Gaussian, GAMESS, MEEP, MPB, FEMLAB
